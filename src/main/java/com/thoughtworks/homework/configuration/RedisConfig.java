...
public class RedisConfig extends CachingConfigurerSupport{
    ...
    public RedisConnectionFactory redisConnectionFactoryForKeyVault(KeyVaultDefine keyVaultDefine, KeyVaultClient keyVaultClient) {
        String[] result = keyVaultClient.getSecret(keyVaultDefine.getRedisKey()).split(",");
